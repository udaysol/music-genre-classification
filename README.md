...
* You can also define and train your **own custom model** by adding a function in `models.py` and calling it in `train.py` or directly defining it in the `train.py`.
